  ...
  return (
    <div className='py-[30px] px-3 lg:px-5'>
      ...
      <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor
        ...
        <span className='w-[44px] h-[44px] flex items-center justify-center text-[10px] leading-[30px] font-[600]' style={{background:'${bgColor}', color:'${textColor}', borderRadius:'6px 0 0 6px'}} >
          {index+1}
        </span>
      </div>
    </div>
